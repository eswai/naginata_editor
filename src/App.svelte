...
// 清音
		...
		"texyu" : {"key": ["e", "m", "p"    ], "kana": "てゅ", "del": 0},
		"dhi"   : {"key": ["e", "j", "k"    ], "kana": "でぃ", "del": 0},
		"dexyu" : {"key": ["e", "j", "p"    ], "kana": "でゅ", "del": 1},
		"toxu"  : {"key": ["d", "m", "l"    ], "kana": "とぅ", "del": 1},
		"doxu"  : {"key": ["d", "j", "l"    ], "kana": "どぅ", "del": 1},
		"sixe"  : {"key": ["r", "m", "o"    ], "kana": "しぇ", "del": 1},
		"tixe"  : {"key": ["g", "m", "o"    ], "kana": "ちぇ", "del": 1},
		"jixe"  : {"key": ["r", "j", "o"    ], "kana": "じぇ", "del": 1},
		"dixe"  : {"key": ["g", "j", "o"    ], "kana": "ぢぇ", "del": 1},
