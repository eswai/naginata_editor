...
// 清音
		...
		"-"     : {"key": [";"              ],  "kana": "ー", "del": 0},
			...
			// 濁音
		"ga"    : {"key": ["j", "f"         ], "kana": "が", "del": 0},
		"gi"    : {"key": ["j", "w"         ], "kana": "ぎ", "del": 0},
		"gu"    : {"key": ["f", "h"         ], "kana": "ぐ", "del": 0},
		"ge"    : {"key": ["j", "x"         ], "kana": "げ", "del": 0},
		"go"    : {"key": ["j", "v"         ], "kana": "ご", "del": 0},
		"za"    : {"key": ["f", "u"         ], "kana": "ざ", "del": 0},
		"zi"    : {"key": ["j", "r"         ], "kana": "じ", "del": 0},
		"zu"    : {"key": ["f", "o"         ], "kana": "ず", "del": 0},
		"ze"    : {"key": ["j", "a"         ], "kana": "ぜ", "del": 0},
		"zo"    : {"key": ["j", "b"         ], "kana": "ぞ", "del": 0},
		"da"    : {"key": ["f", "n"         ], "kana": "だ", "del": 0},
		"di"    : {"key": ["j", "g"         ], "kana": "ぢ", "del": 0},
		"du"    : {"key": ["f", ";"         ], "kana": "づ", "del": 0},
		"de"    : {"key": ["j", "e"         ], "kana": "で", "del": 0},
		"do"    : {"key": ["j", "d"         ], "kana": "ど", "del": 0},
		"ba"    : {"key": ["j", "c"         ], "kana": "ば", "del": 0},
		"bi"    : {"key": ["j", "s"         ], "kana": "び", "del": 0},
		"bu"    : {"key": ["f", "."         ], "kana": "ぶ", "del": 0},
		"be"    : {"key": ["f", "p"         ], "kana": "べ", "del": 0},
		"bo"    : {"key": ["j", "z"         ], "kana": "ぼ", "del": 0},
		"vu"    : {"key": ["f", "l"         ], "kana": "ゔ", "del": 0},

			// 半濁音
		"pa"    : {"key": ["m", "c"         ], "kana": "ぱ", "del": 0},
		"pi"    : {"key": ["m", "s"         ], "kana": "ぴ", "del": 0},
		"pu"    : {"key": ["v", "."         ], "kana": "ぷ", "del": 0},
		"pe"    : {"key": ["v", "p"         ], "kana": "ぺ", "del": 0},
		"po"    : {"key": ["m", "z"         ], "kana": "ぽ", "del": 0},
		...
		"zye"   : {"key": ["j", "r", "o"    ], "kana": "じぇ", "del": 0},
		"zya"   : {"key": ["j", "r", "h"    ], "kana": "じゃ", "del": 0},
		"zyu"   : {"key": ["j", "r", "p"    ], "kana": "じゅ", "del": 0},
		"zyo"   : {"key": ["j", "r", "i"    ], "kana": "じょ", "del": 0},
		"kya"   : {"key": ["w", "h"         ], "kana": "きゃ", "del": 0},
		"kyu"   : {"key": ["w", "p"         ], "kana": "きゅ", "del": 0},
		"kyo"   : {"key": ["w", "i"         ], "kana": "きょ", "del": 0},
		"gya"   : {"key": ["j", "w", "h"    ], "kana": "ぎゃ", "del": 0},
		"gyu"   : {"key": ["j", "w", "p"    ], "kana": "ぎゅ", "del": 0},
		"gyo"   : {"key": ["j", "w", "i"    ], "kana": "ぎょ", "del": 0},
		"tye"   : {"key": ["g", "o"         ], "kana": "ちぇ", "del": 0},
		"tya"   : {"key": ["g", "h"         ], "kana": "ちゃ", "del": 0},
		"tyu"   : {"key": ["g", "p"         ], "kana": "ちゅ", "del": 0},
		"tyo"   : {"key": ["g", "i"         ], "kana": "ちょ", "del": 0},
		"dye"   : {"key": ["j", "g", "o"    ], "kana": "ぢぇ", "del": 0},
		"dya"   : {"key": ["j", "g", "h"    ], "kana": "ぢゃ", "del": 0},
		"dyu"   : {"key": ["j", "g", "p"    ], "kana": "ぢゅ", "del": 0},
		"dyo"   : {"key": ["j", "g", "i"    ], "kana": "ぢょ", "del": 0},
		...
		"bya"   : {"key": ["j", "s", "h"    ], "kana": "びゃ", "del": 0},
		"byu"   : {"key": ["j", "s", "p"    ], "kana": "びゅ", "del": 0},
		"byo"   : {"key": ["j", "s", "i"    ], "kana": "びょ", "del": 0},
		"pya"   : {"key": ["m", "s", "h"    ], "kana": "ぴゃ", "del": 0},
		"pyu"   : {"key": ["m", "s", "p"    ], "kana": "ぴゅ", "del": 0},
		"pyo"   : {"key": ["m", "s", "i"    ], "kana": "ぴょ", "del": 0},
		...
		"ryo"   : {"key": ["e", "i"         ], "kana": "りょ", "del": 0},
			...
			// 清音外来音 濁音外来音
		"thi"   : {"key": ["m", "e", "k"    ], "kana": "てぃ", "del": 0},
		"texyu" : {"key": ["m", "e", "p"    ], "kana": "てゅ", "del": 0},
		"dhi"   : {"key": ["j", "e", "k"    ], "kana": "でぃ", "del": 0},
		"dexyu" : {"key": ["j", "e", "p"    ], "kana": "でゅ", "del": 1},
		"toxu"  : {"key": ["m", "d", "l"    ], "kana": "とぅ", "del": 1},
		"doxu"  : {"key": ["j", "d", "l"    ], "kana": "どぅ", "del": 1},
		"sixe"  : {"key": ["m", "r", "o"    ], "kana": "しぇ", "del": 1},
		"tixe"  : {"key": ["m", "g", "o"    ], "kana": "ちぇ", "del": 1},
		"jixe"  : {"key": ["j", "r", "o"    ], "kana": "じぇ", "del": 1},
		"dixe"  : {"key": ["j", "g", "o"    ], "kana": "ぢぇ", "del": 1},
		...
		"wi"    : {"key": ["v", "l", "k"    ], "kana": "うぃ", "del": 0},
		"we"    : {"key": ["v", "l", "o"    ], "kana": "うぇ", "del": 0},
		"uxo"   : {"key": ["v", "l", "n"    ], "kana": "うぉ", "del": 1},
		"va"    : {"key": ["f", "l", "j"    ], "kana": "ゔぁ", "del": 0},
		"vi"    : {"key": ["f", "l", "k"    ], "kana": "ゔぃ", "del": 0},
		"ve"    : {"key": ["f", "l", "o"    ], "kana": "ゔぇ", "del": 0},
		"vo"    : {"key": ["f", "l", "n"    ], "kana": "ゔぉ", "del": 0},
		...
		"tuxa"  : {"key": ["v", ";", "j"    ], "kana": "つぁ", "del": 1},
		"tuxi"  : {"key": ["v", ";", "k"    ], "kana": "つぃ", "del": 1},
		"tuxe"  : {"key": ["v", ";", "o"    ], "kana": "つぇ", "del": 1},
		"tuxo"  : {"key": ["v", ";", "n"    ], "kana": "つぉ", "del": 1},
